...
%Creating a message that is the action client and naming it our goal so
...
%Next, we make a subscrieber in the joint_states topic becasue we are
...
%This is for adjucting the naming for the kinematics because the naming is
...
% Execute CloseGrippers function to close the grippers to a predetermined
